...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'string', line 19, column 2 to column 10)",
...
class model_example final : public model_base_crtp<model_example> {
private:
  int N;
...
public:
  ...
  inline std::string model_name() const final { return "model_example"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_example_namespace::log_prob";
(void) function__;  // suppress unused var warning
...
using stan_model = model_example_namespace::model_example;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_example_namespace::profiles__;
}
#endif
#endif
