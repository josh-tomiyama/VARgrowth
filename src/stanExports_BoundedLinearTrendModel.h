...
namespace model_BoundedLinearTrendModel_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 304, column 2 to column 34)",
                                                      " (in 'string', line 305, column 2 to column 30)",
                                                      " (in 'string', line 306, column 2 to column 25)",
                                                      " (in 'string', line 308, column 2 to column 18)",
                                                      " (in 'string', line 311, column 2 to column 15)",
                                                      " (in 'string', line 312, column 2 to column 33)",
                                                      " (in 'string', line 313, column 2 to column 34)",
                                                      " (in 'string', line 314, column 2 to column 77)",
                                                      " (in 'string', line 317, column 6 to column 50)",
                                                      " (in 'string', line 316, column 18 to line 318, column 5)",
                                                      " (in 'string', line 316, column 4 to line 318, column 5)",
                                                      " (in 'string', line 315, column 20 to line 319, column 3)",
                                                      " (in 'string', line 315, column 2 to line 319, column 3)",
                                                      " (in 'string', line 320, column 2 to column 63)",
                                                      " (in 'string', line 322, column 2 to column 41)",
                                                      " (in 'string', line 348, column 2 to column 20)",
                                                      " (in 'string', line 350, column 4 to line 351, column 50)",
                                                      " (in 'string', line 349, column 15 to line 352, column 3)",
                                                      " (in 'string', line 349, column 2 to line 352, column 3)",
                                                      " (in 'string', line 326, column 2 to column 69)",
                                                      " (in 'string', line 327, column 2 to column 63)",
                                                      " (in 'string', line 329, column 2 to column 51)",
                                                      " (in 'string', line 330, column 2 to line 333, column 49)",
                                                      " (in 'string', line 334, column 2 to column 83)",
                                                      " (in 'string', line 337, column 4 to line 338, column 40)",
                                                      " (in 'string', line 336, column 15 to line 339, column 3)",
                                                      " (in 'string', line 336, column 2 to line 339, column 3)",
                                                      " (in 'string', line 343, column 45 to column 55)",
                                                      " (in 'string', line 343, column 6 to column 57)",
                                                      " (in 'string', line 342, column 17 to line 344, column 5)",
                                                      " (in 'string', line 342, column 4 to line 344, column 5)",
                                                      " (in 'string', line 340, column 25 to line 345, column 3)",
                                                      ...
                                                      " (in 'string', line 280, column 2 to column 31)",
                                                      " (in 'string', line 283, column 2 to column 43)",
                                                      " (in 'string', line 286, column 9 to column 10)",
                                                      " (in 'string', line 286, column 12 to column 13)",
                                                      " (in 'string', line 286, column 2 to column 28)",
                                                      " (in 'string', line 288, column 9 to column 10)",
                                                      " (in 'string', line 288, column 12 to column 13)",
                                                      " (in 'string', line 288, column 2 to column 28)",
                                                      " (in 'string', line 290, column 9 to column 17)",
                                                      " (in 'string', line 290, column 2 to column 36)",
                                                      " (in 'string', line 292, column 9 to column 17)",
                                                      " (in 'string', line 292, column 2 to column 36)",
                                                      " (in 'string', line 294, column 2 to column 20)",
                                                      " (in 'string', line 296, column 9 to column 10)",
                                                      " (in 'string', line 296, column 2 to column 30)",
                                                      " (in 'string', line 298, column 9 to column 10)",
                                                      " (in 'string', line 298, column 2 to column 30)",
                                                      " (in 'string', line 299, column 2 to column 20)",
                                                      ...
                                                      " (in 'string', line 304, column 21 to column 22)",
                                                      " (in 'string', line 305, column 9 to column 15)",
                                                      " (in 'string', line 305, column 17 to column 18)",
                                                      " (in 'string', line 311, column 9 to column 10)",
                                                      " (in 'string', line 312, column 9 to column 10)",
                                                      " (in 'string', line 312, column 12 to column 13)",
                                                      " (in 'string', line 313, column 9 to column 17)",
                                                      " (in 'string', line 314, column 9 to column 10)",
                                                      " (in 'string', line 314, column 12 to column 13)",
                                                      " (in 'string', line 348, column 9 to column 10)",
...
class model_BoundedLinearTrendModel final : public model_base_crtp<model_BoundedLinearTrendModel> {
private:
  int N;
  int d;
  std::vector<int> u;
...
public:
  ~model_BoundedLinearTrendModel() { }
  
  inline std::string model_name() const final { return "model_BoundedLinearTrendModel"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_BoundedLinearTrendModel(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_BoundedLinearTrendModel_namespace::model_BoundedLinearTrendModel";
    ...
    try {
      ...
      context__.validate_dims("data initialization","pUpperBound1","double",
          context__.to_vec());
      pUpperBound1 = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 72;
      pUpperBound1 = context__.vals_r("pUpperBound1")[(1 - 1)];
      current_statement__ = 73;
      context__.validate_dims("data initialization","pUpperBound2","double",
          context__.to_vec());
      pUpperBound2 = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 73;
      pUpperBound2 = context__.vals_r("pUpperBound2")[(1 - 1)];
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_BoundedLinearTrendModel_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      local_scalar_t__ UpperBound;
      UpperBound = DUMMY_VAR__;
      
      current_statement__ = 5;
      UpperBound = in__.scalar();
        ...
        multiply(XTheta, betaTheta), "assigning variable linear_pred_theta");
      {
        ...
        lp_accum__.add(
          inv_gamma_lpdf<propto__>(SigmaTheta, pSigmaThetaParam1,
            pSigmaThetaParam2));
        current_statement__ = 23;
        lp_accum__.add(
          uniform_lpdf<propto__>(UpperBound, pUpperBound1, pUpperBound2));
        ...
        if (logical_eq(run_estimation, 1)) {
          ...
          for (int i = 1; i <= N; ++i) {
            ...
            if (logical_gt(Z[(i - 1)], UpperBound)) {
              current_statement__ = 29;
              lp_accum__.add(stan::math::negative_infinity());
            } else {
              current_statement__ = 29;
              lp_accum__.add(
                -normal_cdf_log(UpperBound, mu[(i - 1)],
                   stan::math::sqrt(ObsVar)));
            }
            current_statement__ = 30;
            lp_accum__.add(
              normal_lpdf<propto__>(Z[(i - 1)], mu[(i - 1)],
                stan::math::sqrt(ObsVar)));}
        } 
      }
    } catch (const std::exception& e) {
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_BoundedLinearTrendModel_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      vars__.emplace_back(UpperBound);
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        assign(log_lik, cons_list(index_uni(i), nil_index_list()),
          (normal_lpdf<false>(Z[(i - 1)], mu[(i - 1)],
             stan::math::sqrt(ObsVar)) -
            normal_lcdf(UpperBound, mu[(i - 1)], stan::math::sqrt(ObsVar))),
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      current_statement__ = 5;
      UpperBound = context__.vals_r("UpperBound")[(1 - 1)];
      for (int sym1__ = 1; sym1__ <= d; ++sym1__) {
        for (int sym2__ = 1; sym2__ <= U; ++sym2__) {
          vars__.emplace_back(
            rvalue(Theta,
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__.emplace_back("UpperBound");
  ...
  inline void constrained_param_names(
    ...
    param_names__.emplace_back(std::string() + "UpperBound");
    if (emit_transformed_parameters__) {
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        {
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"Theta\",\"type\":{\"name\":\"matrix\",\"rows\":" << U << ",\"cols\":" << d << "},\"block\":\"parameters\"},{\"name\":\"SigmaTheta\",\"type\":{\"name\":\"vector\",\"length\":" << d << "},\"block\":\"parameters\"},{\"name\":\"betaTheta\",\"type\":{\"name\":\"matrix\",\"rows\":" << pTheta << ",\"cols\":" << d << "},\"block\":\"parameters\"},{\"name\":\"ObsVar\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"UpperBound\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"transformed_parameters\"},{\"name\":\"linear_pred_theta\",\"type\":{\"name\":\"matrix\",\"rows\":" << U << ",\"cols\":" << d << "},\"block\":\"transformed_parameters\"},{\"name\":\"longSigmaTheta\",\"type\":{\"name\":\"vector\",\"length\":" << longSigmaTheta_1dim__ << "},\"block\":\"transformed_parameters\"},{\"name\":\"transTheta\",\"type\":{\"name\":\"matrix\",\"rows\":" << U << ",\"cols\":" << d << "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_BoundedLinearTrendModel_namespace::model_BoundedLinearTrendModel;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_BoundedLinearTrendModel_namespace::profiles__;
}
#endif
#endif
