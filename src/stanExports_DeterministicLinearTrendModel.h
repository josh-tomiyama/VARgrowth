...
namespace model_DeterministicLinearTrendModel_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 298, column 2 to column 25)",
                                                      " (in 'string', line 301, column 2 to column 15)",
                                                      " (in 'string', line 302, column 2 to column 26)",
                                                      " (in 'string', line 303, column 2 to column 21)",
                                                      " (in 'string', line 304, column 2 to column 29)",
                                                      " (in 'string', line 305, column 2 to column 64)",
                                                      " (in 'string', line 306, column 2 to column 63)",
                                                      " (in 'string', line 320, column 2 to column 20)",
                                                      " (in 'string', line 322, column 4 to column 57)",
                                                      " (in 'string', line 321, column 15 to line 323, column 3)",
                                                      " (in 'string', line 321, column 2 to line 323, column 3)",
                                                      " (in 'string', line 309, column 2 to column 69)",
                                                      " (in 'string', line 310, column 2 to line 313, column 49)",
                                                      " (in 'string', line 314, column 2 to column 83)",
                                                      " (in 'string', line 316, column 6 to column 34)",
                                                      " (in 'string', line 315, column 25 to line 317, column 3)",
                                                      ...
                                                      " (in 'string', line 297, column 9 to column 15)",
                                                      " (in 'string', line 297, column 17 to column 18)",
...
class model_DeterministicLinearTrendModel final : public model_base_crtp<model_DeterministicLinearTrendModel> {
private:
  int N;
  int d;
  std::vector<int> u;
...
public:
  ~model_DeterministicLinearTrendModel() { }
  
  inline std::string model_name() const final { return "model_DeterministicLinearTrendModel"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_DeterministicLinearTrendModel(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_DeterministicLinearTrendModel_namespace::model_DeterministicLinearTrendModel";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_DeterministicLinearTrendModel_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      assign(Theta, nil_index_list(), multiply(XTheta, betaTheta),
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_DeterministicLinearTrendModel_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"betaTheta\",\"type\":{\"name\":\"matrix\",\"rows\":" << pTheta << ",\"cols\":" << d << "},\"block\":\"parameters\"},{\"name\":\"ObsVar\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"transformed_parameters\"},{\"name\":\"transTheta\",\"type\":{\"name\":\"matrix\",\"rows\":" << U << ",\"cols\":" << d << "},\"block\":\"transformed_parameters\"},{\"name\":\"Theta\",\"type\":{\"name\":\"matrix\",\"rows\":" << U << ",\"cols\":" << d << "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_DeterministicLinearTrendModel_namespace::model_DeterministicLinearTrendModel;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_DeterministicLinearTrendModel_namespace::profiles__;
}
#endif
#endif
